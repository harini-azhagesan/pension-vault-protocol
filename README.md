...
- **⛓️ Blockchain Contribution Logging** — Every contribution is SHA-256 hashed and recorded on an Ethereum VM via Hardhat
...
- **🏛️ Legacy Plan** — Smart-contract based heir management with configurable timeout release
